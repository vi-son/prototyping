(function () {
	...
	*/
	...
	var reactDom_development=createCommonjsModule(function(module,exports){{(function(){var React=react;var _assign=objectAssign;var Scheduler=scheduler;var checkPropTypes=checkPropTypes_1;var tracing$1=tracing;var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// Prevent newer renderers from RTE when used with older react package versions.
	...
	/// TODO:
	var audioUrl = "/audio/patterns.202006.mp3";
	var audioCtx = new AudioContext();
	console.log("Welcome: ".concat(audioUrl));
	...
	reactDom.render( /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(AudioPlayer, null), /*#__PURE__*/react.createElement(FileUpload, null)), mount); // let essentia;
